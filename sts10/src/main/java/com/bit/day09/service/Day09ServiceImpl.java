...
//		model.addAttribute("alist",day09Dao.selectAll());
	...
	@Override
	public void getList(Model model, int su) throws SQLException {
		Map<String, Integer> map = new HashMap<String, Integer>();
		model.addAttribute("alist",sqlSession.getMapper(Day09Dao.class).selectAll(map));
	}
...
//		System.out.println(bean.getNalja().toString());
